        ...
        >
          ...
          <div className="flex flex-col items-center mb-8 relative group">
            <label
              ...
              className="w-32 h-32 rounded-full bg-gray-200 flex items-center justify-center cursor-pointer overflow-hidden shadow-lg hover:scale-105 transition border-4 border-blue-100"
            >
              {imagePreview ? (
                <img
                  src={imagePreview}
            ...
            <p className="text-sm text-gray-500 mt-2">Click to upload logo</p>
            {imagePreview && (
              <button
                ...
                {isTextarea ? (
                  <textarea
                    ...
                    className={`w-full px-4 py-3 rounded-xl border-2 transition-all focus:outline-none resize-none ${
                      focusedField === key
                        ? "border-blue-500 shadow-lg ring-4 ring-blue-500 ring-opacity-20 scale-105"
